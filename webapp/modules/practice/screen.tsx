...
import { composeTopicId, findStandardByTopicId } from "./practice-target";
import { SkillBrowser } from "./skill-browser";
import { GradePicker, SignInCard } from "./auth-screens";
...
export function StudentScreen() {
  ...
  if (needsGrade) {
    return <GradePicker choices={gradeChoices} onPick={pickGrade} />;
  }
